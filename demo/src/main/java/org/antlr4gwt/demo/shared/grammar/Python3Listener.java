...
public interface Python3Listener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link Python3Parser#varray}.
	 * @param ctx the parse tree
	 */
	void enterVarray(@NotNull Python3Parser.VarrayContext ctx);
	/**
	 * Exit a parse tree produced by {@link Python3Parser#varray}.
	 * @param ctx the parse tree
	 */
	void exitVarray(@NotNull Python3Parser.VarrayContext ctx);
	/**
